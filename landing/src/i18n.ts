...
const messages = {
  zh: {
    ...
    features: {
      ...
      items: [
        ...
        { title: '数据分析', desc: 'ECharts 可视化报表，营业额、用户数量、订单趋势一目了然' },
        { title: '实时推送', desc: 'WebSocket 实时来单提醒、催单通知，不错过任何一笔订单' },
        { title: '安全认证', desc: 'JWT Token 认证授权，员工权限分级管理，数据安全保障' },
        { title: '云端存储', desc: '阿里云 OSS 对象存储，菜品图片、报表文件安全可靠' }
      ]
    },
    tech: {
      badge: '技术架构',
  ...
  en: {
    ...
    hero: {
      ...
      desc: 'All-in-one food delivery solution\nWeChat Mini Program · Admin Panel · Real-time Analytics',
      cta1: 'Get Started →',
      cta2: 'View Source',
      stat1: 'Platforms',
      stat2: 'Features',
